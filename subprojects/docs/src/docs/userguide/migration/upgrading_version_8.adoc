...
- The JaCoCo code coverage tool used by the `jacoco` plugin has been upgraded to https://github.com/jacoco/jacoco/releases/tag/v0.8.9[0.8.9].
...
Since the previous version was 3.0.10, the https://groovy-lang.org/changelogs/changelog-3.0.16.html[3.0.16] changes are also included.
